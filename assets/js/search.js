...
if(query){
 ...
 try{
  ...
  main.querySelector('.dg-lead').textContent=`${hits.length} resultados para “${query}”.`;
 ...
 }catch{main.querySelector('.dg-lead').textContent='Não foi possível efectuar a pesquisa. Consulte os temas ou tente novamente.';}
}