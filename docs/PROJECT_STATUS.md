...
* Parcialmente validado: D02, D04, D05, D06, D08, D09, D10, D11, D12, D13 e CM.
* Por confirmar em PRD para publicação como comportamento actual: D07.
...
Prioridade de revisão profunda: CM. D04, D05 e D07 receberam revisão profunda em 22/09/2026. D07 permanece Por confirmar em PRD para publicação como comportamento actual.
...
3. Rever os 15 guias e classificar cada um como validado, parcialmente validado ou por validar. Primeira passagem concluída em `docs/CONTENT_VALIDATION.md`; revisões profundas concluídas para D04, D05 e D07.
